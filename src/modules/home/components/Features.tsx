  ...
  const featuresList = [
    {
      ...
      description:
        "Nossos algoritmos de grafos encontram o caminho mais curto e eficiente para a coleta e entrega de itens, economizando tempo e recursos.",
    },
    {
      icon: <FaEye className="text-4xl text-blue-500 mb-4" />,
      title: "Visualização em Tempo Real",
      description:
        "Monitore o fluxo de trabalho do seu galpão com um mapa interativo. Veja a posição de empilhadeiras e o status dos pedidos em tempo real.",
    },
    {
      icon: <FaChartLine className="text-4xl text-blue-500 mb-4" />,
      title: "Análise Preditiva e Relatórios",
      description:
        "Identifique gargalos e tendências com relatórios detalhados. Previna problemas antes que eles ocorram e otimize a capacidade do seu armazém.",
    },
    {
      ...
      description:
        "Organize seu estoque de forma lógica para minimizar o tempo de deslocamento. Coloque itens de alta demanda próximos às saídas para maior eficiência.",
    },
  ];
